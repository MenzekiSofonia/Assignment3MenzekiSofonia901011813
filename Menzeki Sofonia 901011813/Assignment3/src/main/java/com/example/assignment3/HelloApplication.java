...
public class HelloApplication extends Application {
    ImageView cloud3 = new ImageView("cloud.png");
    ...
    ImageView image = new ImageView(new Image("aero.gif"));
    ImageView gameOver = new ImageView("over.gif");
    ImageView coin = new ImageView("coin.gif");
    ImageView coin1 = new ImageView("coin1.gif");
    ...
    public void start(Stage stage) {
        ...
        button.setOnMouseClicked((event) ->{
            root.getChildren().addAll(aeroplane, cloud2,cloud3,cloud4,cloud5,coin,score1,score2,coin1);
        ...
        score2.setTranslateX(480);





        stage.setTitle("My AeroPlane Game");
